...
**기존 스타일 레퍼런스**
- [탐험 컨셉 아트](../../../art/concepts/legacy-ui/탐험%20컨셉아트.png): 심연형 여백, 작은 조사관, 청록 랜턴, 다세계 건축 파편
- [잘못된 그림자 화톳불 이벤트](../../../art/concepts/legacy-ui/잘못된%20그림자%20화툿불%20이벤트%20컨셉아트.png): 높은 시점, 황동색 화광, 파티 실루엣, 검은 외곽부
- [잘못 붙여진 복도](../../../art/concepts/legacy-ui/잘못%20붙여진%20복도%20컨셉아트.png): 서로 다른 건축 재질의 봉합 방식
- [거두는 자](../../../art/concepts/legacy-ui/거두는자%20컨셉아트.png): 초기 농경 신앙 토착신의 크기와 위계
- [우상숭배 이벤트](../../../art/concepts/legacy-ui/우상숭배%20이벤트%20컨셉아트.png): 단일 이상 현상과 의식 공간의 연출
