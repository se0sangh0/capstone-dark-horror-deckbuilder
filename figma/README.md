...
1. **노드 시스템**: `archive/2026-08-01_Notion_이전/기획/시스템/12_맵_노드_설계.md`
   - 10층 구조, 3갈래 분기
   - 화툿불 9층 고정, 보스 10층 고정
   - 전투 60%, 용병소 40% 가중치

2. **전투 시스템**: `archive/2026-08-01_Notion_이전/기획/시스템/02_전투_시스템_명세.md`
   - 턴 페이즈 구조
   - 스킬 코스트 기반 선공 판정
   - 공용 스택 시스템

3. **카드 시스템**: `archive/2026-08-01_Notion_이전/기획/시스템/03_카드_설계_프레임.md`
   - 40장 덱 (파티원 4명 × 10장)
   - 성향별 스택 값 생성
   - 덱 고갈 시 탈진

4. **동료 데이터**: `archive/2026-08-01_Notion_이전/기획/시스템/10_동료_스킬_데이터.md`
   - 6종 직업 MVP
   - 스킬 코스트 데이터
   - 역할별 분류

5. **캐릭터 시트**: `archive/2026-08-01_Notion_이전/기획/시스템/09_캐릭터_시트_프로토타입.md`
